...
import com.xinggq.pattern.command.secondemo.command.AddCommand;
import com.xinggq.pattern.command.secondemo.command.Command;
import com.xinggq.pattern.command.secondemo.command.SubstractCommand;
import com.xinggq.pattern.command.secondemo.reciver.Operation;
import com.xinggq.pattern.command.secondemo.reciver.OperationApi;

/**
 * @author xinggq
 * @date 2019-07-12 11:08
 * @description
 */
public class Client {
  public static void main(String[] args) {
    ...
    //创建命令对象，并组装命令和接收者
    Command addCmd = new AddCommand(operation,5);
    Command substractCmd = new SubstractCommand(operation,3);
